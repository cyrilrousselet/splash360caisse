const catalogue = require('./catalogue_dimsum.json');
...
const hydration = {
  ...
  parametres: [
    ...
    { domaine: 'entreprise', cle: 'code_postal', valeur: '77340'},
    { domaine: 'entreprise', cle: 'ville', valeur: 'PONTAULT COMBAULT'},
    { domaine: 'entreprise', cle: 'telephone', valeur: '01 60 64 05 02'},
